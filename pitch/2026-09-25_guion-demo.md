...
> **Actualización (25-sep, 17:15; contrato redesplegado el 26-sep por la decisión #42):** el contrato está en testnet: [`CBNBVFY2BXFC7GGMCK7SWXSWHMWWNXS5U4XRNBSX6FRFIVZBZDYBCCD3`](https://stellar.expert/explorer/testnet/contract/CBNBVFY2BXFC7GGMCK7SWXSWHMWWNXS5U4XRNBSX6FRFIVZBZDYBCCD3). Hoy la demo es **nivel 2: `demo/demo.sh`** (sin frontend). Usa las filas 5 y 6 de la tabla de preparación y el plan B como demo principal; la vista de app queda como siguiente paso.
