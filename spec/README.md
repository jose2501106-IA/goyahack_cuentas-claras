...
| `2026-09-26_especificacion-frontend.md` | **Vigente para el fin de semana** (26-sep, 01:00; depende de #44 y #45) | App local de cuatro vistas sin paquetes npm, API sobre el Stellar CLI, semáforo honesto, segundo emisor, criterios de aceptación y prompt |
