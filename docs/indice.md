...
| [`docs/diseno-web-movil.md`](diseno-web-movil.md) | Sitio público en el celular: tres paletas con contraste verificado, tres propuestas de experiencia, «HTML primero» y prompt para Claude Code. | #marca #demo | 1151 | Antes de diseñar o revisar `web/` | propuesta |
...
| [`demo/capturas/`](../demo/capturas/) | Capturas de la app con datos ficticios. `web-*.png`: el sitio público en 1920 px y 390 px (Inicio, Pasillo vivo en el día 90, demo real y Cómo funciona). `pasillo-a-b-plana.png`: el mapa del Pasillo A-B (forma de `plano/pasillo-a-b.json`) con el estado real de testnet (SVG de la vista exportado sin navegador, vista plana). | #demo | — | Para el deck o el README | vigente |
