...
| [`docs/decisiones.md`](decisiones.md) | Bitácora de decisiones #1–#46 con fecha, motivo y estado; retroalimentación de mentores; lo descartado. | #decisiones | 2,301 | Antes de cambiar cualquier cosa | vigente |
...
| [`demo/sembrar.sh`](../demo/sembrar.sh) | Segundo emisor para la demo (spec del frontend §6): Bodega B crea, Doña Mary acepta y Bodega B confirma; una sola vez. Ver decisión #46. | #demo | — | Antes de grabar | vigente |
...
| [`frontend/`](../frontend/) | Cuatro vistas en HTML, CSS y JS sin framework: Bodega A, Teléfono de Doña Mary, Bodega B y Para el jurado. | #demo | — | Al tocar la app | vigente |
