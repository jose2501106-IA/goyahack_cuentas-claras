...
(Bodega A-17, Teléfono de Doña Mary, Bodega B-40 y Para el jurado) sobre el mismo contrato de testnet que `demo.sh`. Node 20 con módulos nativos: **sin `npm install` y sin
