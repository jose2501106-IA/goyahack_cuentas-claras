...
- **Alcance del fin de semana:** lo que piden `spec/2026-09-26_especificacion-frontend.md` (app local que firma; #43–#45), `spec/2026-09-26_especificacion-gemelo-digital.md` (#47, #48) y `spec/2026-09-26_especificacion-web-y-agentes.md` (sitio público en `web/` y simulación de agentes; #49–#51). El trabajo autónomo sigue `docs/cola-de-trabajo.md` y solo toca `web/`, `docs/` y `README.md`. El contrato no se toca salvo error de seguridad, y cualquier redespliegue lo aprueba José. Nada fuera de esa spec sin que José lo pida.
