...
(window.CC_DATOS = window.CC_DATOS || {})["repeticion"] = {
  ...
  "pasos": [
    ...
    },
    {
      ...
      "hash": null,
      "url": null,
      "sin_transaccion": "No se envió transacción: el contrato lo rechazó.",
      "detalle_salida": "NoConsent — el contrato no entrega el resumen sin permiso (no se envía transacción)"
    },
    {
      "numero": 5,
